...
void GimbalConsole(void) 
{
  ...
  else if (gimbal_direct.mode == GIMBAL_IMU || gimbal_direct.mode== GIMBAL_GAP || GIMBAL_INIT)
  {
...
void GimbalSendCmd(void) 
{
    ...
    ModifyDebugDataPackage(1,gimbal_direct.yaw.set.vel,"y_v_r");
    ModifyDebugDataPackage(2,gimbal_direct.feedback_vel.yaw,"y_v_f");
    ModifyDebugDataPackage(3,gimbal_direct.yaw.fdb.pos,"y_p_f");
    ModifyDebugDataPackage(4,gimbal_direct.reference.yaw,"y_p_r");
