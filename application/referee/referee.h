...
typedef __packed struct  //0x0204
{
    ...
    uint8_t remaining_energy;               // 剩余能量比例标识
} buff_t;
...
typedef __packed struct //0x0311
{ 
uint8_t data[30]; 
...
extern CustomControllerData_t custom_controller_data;
...
extern robot_custom_data_t * GetCustomControllerDataPoint(void);
