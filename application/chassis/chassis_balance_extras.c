...
void GetK(float l, float k[2][6], bool is_take_off)
{
    ...
    float t2 = l * l;
    float t3 = l * l * l;
    k[0][0] = -96.7656f * t3 + 78.7960f * t2 - 27.1439f * t1 - 0.0131f;
    k[0][1] = -2.3420f * t3 + 2.4747f * t2 - 2.3907f * t1 + 0.0631f;
    k[0][2] = -21.5669f * t3 + 15.5079f * t2 - 3.9448f * t1 - 0.0757f;
    k[0][3] = -22.8042f * t3 + 16.6079f * t2 - 4.4929f * t1 - 0.0829f;
    k[0][4] = -45.3397f * t3 + 38.8109f * t2 - 12.8285f * t1 + 1.8883f;
    k[0][5] = -4.2938f * t3 + 4.1261f * t2 - 1.5728f * t1 + 0.2865f;
    k[1][0] = 37.6656f * t3 - 13.5040f * t2 - 3.5939f * t1 + 2.2853f;
    k[1][1] = 9.3161f * t3 - 6.2996f * t2 + 1.2748f * t1 + 0.0867f;
    k[1][2] = -32.0600f * t3 + 27.4435f * t2 - 9.0711f * t1 + 1.3352f;
    k[1][3] = -31.8641f * t3 + 27.5014f * t2 - 9.2088f * t1 + 1.3957f;
    k[1][4] = 152.5007f * t3 - 109.6573f * t2 + 27.8936f * t1 + 0.5352f;
    k[1][5] = 22.5185f * t3 - 16.4976f * t2 + 4.3188f * t1 - 0.0789f;
