...
void GetK(float l, float k[2][6], bool is_take_off)
{
    ...
    float t2 = l * l;
    float t3 = l * l * l;
    k[0][0] = -352.4973f * t3 + 270.2265f * t2 - 108.0165f * t1 - 11.2078f;
    k[0][1] = -21.3164f * t3 + 10.3207f * t2 - 12.9726f * t1 - 2.5096f;
    k[0][2] = -92.2958f * t3 + 69.8751f * t2 - 19.2187f * t1 - 7.9570f;
    k[0][3] = -3.7169f * t3 + 2.1467f * t2 - 3.0615f * t1 - 8.5712f;
    k[0][4] = -422.6616f * t3 + 369.2614f * t2 - 129.4445f * t1 + 21.6086f;
    k[0][5] = -37.1856f * t3 + 30.9312f * t2 - 10.2770f * t1 + 1.7528f;
    k[1][0] = -58.6847f * t3 + 77.9868f * t2 - 40.3722f * t1 + 10.4026f;
    k[1][1] = -29.5871f * t3 + 26.5300f * t2 - 9.8222f * t1 + 2.1706f;
    k[1][2] = -133.6573f * t3 + 116.7707f * t2 - 40.9340f * t1 + 6.8332f;
    k[1][3] = -162.0168f * t3 + 132.9637f * t2 - 42.9283f * t1 + 6.5692f;
    k[1][4] = 291.8648f * t3 - 220.9645f * t2 + 60.7749f * t1 + 25.1623f;
    k[1][5] = 28.1209f * t3 - 21.0813f * t2 + 5.7573f * t1 + 0.8621f;
