...
#define SEND_DURATION_GameStatus  5  // ms
#define SEND_DURATION_GameResult  5  // ms
#define SEND_DURATION_AllRobotHp  5  // ms
#define SEND_DURATION_Event       5  // ms
#define SEND_DURATION_RefereeWarning 5  // ms
#define SEND_DURATION_DartInfo     5  // ms
#define SEND_DURATION_RobotStatus  5// ms
#define SEND_DURATION_PowerHeat 5// ms
#define SEND_DURATION_RobotPos 5// ms
#define SEND_DURATION_Buff   5// ms
#define SEND_DURATION_Hurt 5// ms
#define SEND_DURATION_Shoot 5// ms
#define SEND_DURATION_ProjectileAllowance 5// ms
#define SEND_DURATION_RfidStatus 5// ms
#define SEND_DURATION_DartClientCmd 5// ms
#define SEND_DURATION_GroundRobotPosition 5// ms
